...
import { updateBannerDtoSchema, type TUpdateBannerDto } from '@/features/banners/admin/dtos/update-banner.ts';
import type { TBannerDto } from '@/features/banners/admin/dtos/banner.ts';
