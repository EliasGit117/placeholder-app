...
export const Route = createFileRoute('/_public/todos/')({
...
function RouteComponent() {
  ...
  return (
    <main className="container mx-auto p-4">
      <section className="relative overflow-hidden border border-border/60 bg-[linear-gradient(135deg,var(--color-background),var(--color-muted)_45%,var(--color-secondary))]">
        <div
          className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,var(--color-accent),transparent_28%),radial-gradient(circle_at_bottom_right,var(--color-muted),transparent_30%)] opacity-70"/>
        ...
        <div className="relative grid gap-4 px-4 py-4 md:px-5 md:py-5 lg:grid-cols-[1.2fr_0.95fr] lg:gap-4">
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-2.5 sm:grid-cols-3">
              <div className="border border-border/70 bg-background/70 p-3 backdrop-blur">
          ...
          <Card className="shadow-none">
            ...
            <CardContent className="space-y-3 py-4">
              ...
              <div className=" border border-dashed border-border bg-background/70 p-4">
            ...
            {isPending ? (
              <div className="space-y-2.5">
                {Array.from({ length: 3 }).map((_, index) => (
                  <div
                    key={index}
                    className="border border-border/60 bg-background/70 p-4"
                  >
              ...
              <Empty className=" border border-dashed border-border bg-background/70 p-8">
                <EmptyHeader>
